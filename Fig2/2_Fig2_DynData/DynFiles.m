...
[X0,Y0,Z0]=Lorenz_signal(h,Lin,y0,Q); % transition phase
y0=[X0(end),Y0(end),Z0(end)].';  % init. cond. on the attractor

[Y0,~,~]=Lorenz_signal(h,L+LP-1,y0,Q); % learning pase
Q=predict(Y0,Q); % prediction phase
U=Q.U;
XP=Q.XP;
